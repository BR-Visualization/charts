...
stacked_barchart1 <- readPNG(test_path("stacked_barchart1.png"))
...
stacked_barchart2 <- readPNG(test_path("stacked_barchart2.png"))
...
stacked_barchart3 <- readPNG(test_path("stacked_barchart3.png"))
